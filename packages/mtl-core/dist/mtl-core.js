(function (global, factory) {
	...
	/*#__PURE__*/
	function (_Component) {
	  inheritsLoose(ReferTable, _Component);

	  function ReferTable() {
	    return _Component.apply(this, arguments) || this;
	  }

	  var _proto = ReferTable.prototype;
	  ...
	  _proto.render = function render() {
	    return React__default.createElement("div", null, "ReferTable"); // const { getFieldError, getFieldProps } = this.props.form;
	    // const props = {
	...
	function (_Component) {
	  ...
	  _proto.render = function render() {
	    return React__default.createElement("div", null, this.renderComp(), React__default.createElement(ReferTable, null));
	  };
